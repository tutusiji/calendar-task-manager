...
export const RANKS: RankInfo[] = [
  ...
  { name: '秩序白银Ⅲ', min: 60, color: '#9d9890', tier: 'silver' },
  { name: '秩序白银Ⅱ', min: 80, color: '#9d9890', tier: 'silver' },
  { name: '秩序白银Ⅰ', min: 100, color: '#9d9890', tier: 'silver' },
  ...
  { name: '尊贵铂金Ⅳ', min: 240, color: '#917f59', tier: 'platinum' },
  { name: '尊贵铂金Ⅲ', min: 280, color: '#917f59', tier: 'platinum' },
  { name: '尊贵铂金Ⅱ', min: 320, color: '#917f59', tier: 'platinum' },
  { name: '尊贵铂金Ⅰ', min: 360, color: '#917f59', tier: 'platinum' },
